...
//        [newCook setValue:[[cooksArray objectAtIndex:i] objectForKey:@"menuItems"] forKey:@"menu_items"];

//        cooksArray =[[cooksArray objectAtIndex:i] objectForKey:@"menuItems"];
//        [menuItemsRef insertMenuItems : cooksArray];
