...
-(void)handleWithFailure:(NSError *)error
{
    ...
    if (error.code==-1011 ) {
        ...
        [alert showCustom:self image:[UIImage imageNamed:@"alert_warningIcon.png"] color:[UIColor orangeColor] title:@"Oops" subTitle:@"There is no cooks in the selected area" closeButtonTitle:@"OK" duration:0.0f];
